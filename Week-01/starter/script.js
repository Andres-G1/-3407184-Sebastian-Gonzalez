...
console.log('Categoría:       Bienestar Mental');
...
console.log('Dias x precio:    ', 3 * 1000); // TODO: reemplaza 0 con tu cálculo
...
console.log('En mantenimiento:  ', false);
...
console.log('Cuida tu salud y vive al 100% la vida');
